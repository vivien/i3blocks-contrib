...
NOTE: if your default shell is different from `bash` (`zsh`, `fish` etc.), then you might want to edit a global `command` property in your config to `bash $SCRIPT_DIR/$BLOCK_NAME/$BLOCK_NAME`
