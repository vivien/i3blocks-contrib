...
image:https://img.shields.io/aur/version/i3blocks-contrib?style=flat-square[AUR version]
image:https://img.shields.io/aur/version/i3blocks-contrib-git?label=aur-git&style=flat-square[AUR git version]
